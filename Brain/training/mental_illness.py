...
train_dataset = BrainDataset(csv_file= 'BrainPrediction/train_mental.csv', root_dir="/mnt/bulk/radhika/project/projT1/20252", tio=tio)
val_dataset = BrainDataset(csv_file = 'BrainPrediction/test_mental.csv', root_dir="/mnt/bulk/radhika/project/projT1/20252", tio=tio)  # Assuming 'test.csv' as the validation dataset
