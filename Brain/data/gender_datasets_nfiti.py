...
for zipfile_path in list(Path('20252').glob('*.zip'))[:500]:   
...
train_df = train_df
print(train_df.shape)
train_df.to_csv('BrainPrediction/train_gender.csv', index = False)
test_df.to_csv('BrainPrediction/test_gender.csv', index = False)
# %%
